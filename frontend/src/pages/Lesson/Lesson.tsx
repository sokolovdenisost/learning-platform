...
export const Lesson = () => {
  ...
  const learnLessons = infoTakeLesson[0] ? infoTakeLesson[0].currentLesson : lesson.course.lessons.length + 1;
  const maxLessons = lesson.course.lessons.length;

  const procent = useProcent(learnLessons, maxLessons);
    ...
    <Layout>
      <div className="lesson-page">
        ...
        <div className="lesson-course-body">
          ...
          <div className="lesson-body-blocks">{mapBlocks}</div>
        ...
        {active.active ? (
          <WatchAnotherLesson
            currentLesson={infoTakeLesson.length ? infoTakeLesson[0].currentLesson : null}
