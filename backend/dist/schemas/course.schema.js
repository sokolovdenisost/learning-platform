...
__decorate([
    mongoose_1.Prop({ type: photo_schema_1.Photo, required: true }),
...
__decorate([
    mongoose_1.Prop({ type: [mongoose.Schema.Types.ObjectId], ref: 'Lesson' }),
    __metadata("design:type", Array)
], Course.prototype, "lessons", void 0);
__decorate([
    mongoose_1.Prop({ type: [{ user: { type: mongoose.Types.ObjectId, ref: 'User' }, ratingNum: Number }] }),
    __metadata("design:type", Array)
